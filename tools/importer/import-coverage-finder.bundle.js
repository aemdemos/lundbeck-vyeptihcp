...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-coverage-finder.js
  var import_coverage_finder_exports = {};
  __export(import_coverage_finder_exports, {
    default: () => import_coverage_finder_default
  });

  // tools/importer/parsers/coverage-finder.js
  var VENDOR_SCRIPT = "https://www.vyeptihcp.com/etc.clientlibs/vyepti-hcp/clientlibs/clientlib-coverage-finder.min.js";
  ...
  var import_coverage_finder_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_coverage_finder_exports);
})();
