...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-why-iv-infusion.js
  var import_why_iv_infusion_exports = {};
  __export(import_why_iv_infusion_exports, {
    default: () => import_why_iv_infusion_default
  });
  ...
  var import_why_iv_infusion_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_why_iv_infusion_exports);
})();
