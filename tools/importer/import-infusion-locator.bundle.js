...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-infusion-locator.js
  var import_infusion_locator_exports = {};
  __export(import_infusion_locator_exports, {
    default: () => import_infusion_locator_default
  });

  // tools/importer/parsers/infusion-locator.js
  function parse(element, { document, params }) {
    ...
    let mapsKey = "";
    const mapsScript = [...document.querySelectorAll('script[src*="maps.googleapis.com"]')].map((s) => s.getAttribute("src")).find(Boolean);
    if (mapsScript) {
  ...
  var import_infusion_locator_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_infusion_locator_exports);
})();
